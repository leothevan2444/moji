...
func TestGetTorrentList(t *testing.T) {
	c := requireQBT(t)
	torrents, err := c.GetTorrentList(context.Background(), nil)
	if err != nil {
...
func TestGetTorrentGenericProperties(t *testing.T) {
	c := requireQBT(t)
	hash := requireQBTTestHash(t)
	properties, err := c.GetTorrentGenericProperties(context.Background(), hash)
	if err != nil {
...
func TestGetTorrentTrackers(t *testing.T) {
	c := requireQBT(t)
	hash := requireQBTTestHash(t)
	trackers, err := c.GetTorrentTrackers(context.Background(), hash)
	if err != nil {
...
func TestGetTorrentWebSeeds(t *testing.T) {
	c := requireQBT(t)
	hash := requireQBTTestHash(t)
	webSeeds, err := c.GetTorrentWebSeeds(context.Background(), hash)
	if err != nil {
...
func TestGetTorrentContents(t *testing.T) {
	c := requireQBT(t)
	hash := requireQBTTestHash(t)
	contents, err := c.GetTorrentContents(context.Background(), hash, nil)
	if err != nil {
...
func TestGetTorrentPiecesStates(t *testing.T) {
	c := requireQBT(t)
	hash := requireQBTTestHash(t)
	piecesStates, err := c.GetTorrentPiecesStates(context.Background(), hash)
	if err != nil {
...
func TestGetTorrentPiecesHashes(t *testing.T) {
	c := requireQBT(t)
	hash := requireQBTTestHash(t)
	piecesHashes, err := c.GetTorrentPiecesHashes(context.Background(), hash)
	if err != nil {
...
func TestPauseTorrents(t *testing.T) {
	...
	hash := requireQBTTestHash(t)
	err := c.PauseTorrents(context.Background(), []string{hash})
	if err != nil {
...
func TestResumeTorrents(t *testing.T) {
	c := requireDestructiveQBT(t)
	hash := requireQBTTestHash(t)
	err := c.ResumeTorrents(context.Background(), []string{hash})
	if err != nil {
...
func TestDeleteTorrents(t *testing.T) {
	c := requireDestructiveQBT(t)
	hash := requireQBTTestHash(t)
	err := c.DeleteTorrents(context.Background(), []string{hash}, false)
	if err != nil {
...
func TestRecheckTorrents(t *testing.T) {
	c := requireDestructiveQBT(t)
	hash := requireQBTTestHash(t)
	err := c.RecheckTorrents(context.Background(), []string{hash})
	if err != nil {
...
func TestReannounceTorrents(t *testing.T) {
	c := requireDestructiveQBT(t)
	hash := requireQBTTestHash(t)
	err := c.ReannounceTorrents(context.Background(), []string{hash})
	if err != nil {
...
func TestAddNewTorrent(t *testing.T) {
	c := requireDestructiveQBT(t)
	err := c.AddNewTorrent(context.Background(), AddTorrentOptions{
...
func TestGetTorrentDownloadLimit(t *testing.T) {
	c := requireQBT(t)
	hash := requireQBTTestHash(t)
	limit, err := c.GetTorrentDownloadLimit(context.Background(), []string{hash})
	if err != nil {
...
func TestGetTorrentUploadLimit(t *testing.T) {
	c := requireQBT(t)
	hash := requireQBTTestHash(t)
	limit, err := c.GetTorrentUploadLimit(context.Background(), []string{hash})
	if err != nil {
...
func TestGetAllCategories(t *testing.T) {
	c := requireQBT(t)
	categories, err := c.GetAllCategories(context.Background())
	if err != nil {
