...
export type UpdateIngestSettingsDocumentMutation = { __typename?: 'Mutation', updateIngestSettings: { __typename?: 'Settings', ingest: { __typename?: 'IngestSettings', mode: string, libraryPath: string, qbittorrentPathPrefix: string, stashPathPrefix: string, transferAction: string, transferTargetPath: string } } };
