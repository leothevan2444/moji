...
export type Mutation = {
  ...
  refreshStashPerformerScenes: StashPerformerSceneConnection;
  ...
  refreshSubscribedPerformers: PerformerBatchPayload;
  ...
  subscribePerformers: PerformerBatchPayload;
  ...
  unsubscribePerformers: PerformerBatchPayload;
...
export type MutationProcessTaskIngestArgs = {
  ids: Array<Scalars['ID']['input']>;
};
...
export type MutationRefreshStashPerformerScenesArgs = {
  id: Scalars['ID']['input'];
...
export type MutationRefreshSubscribedPerformersArgs = {
  ids: Array<Scalars['ID']['input']>;
};
...
export type MutationRetryTasksArgs = {
  ids: Array<Scalars['ID']['input']>;
};
...
export type MutationSubscribePerformersArgs = {
  ids: Array<Scalars['ID']['input']>;
};
...
export type MutationUnsubscribePerformersArgs = {
  ids: Array<Scalars['ID']['input']>;
};
...
export type PerformerBatchPayload = {
  __typename?: 'PerformerBatchPayload';
  batchId: Scalars['ID']['output'];
  results: Array<PerformerBatchResult>;
  summary: PerformerBatchSummary;
};

export type PerformerBatchResult = {
  __typename?: 'PerformerBatchResult';
  performer?: Maybe<StashPerformer>;
  performerId: Scalars['ID']['output'];
  reasonCode: Scalars['String']['output'];
  state?: Maybe<SubscribedPerformer>;
  status: PerformerBatchStatus;
};

export enum PerformerBatchStatus {
  Failed = 'FAILED',
  Skipped = 'SKIPPED',
  Succeeded = 'SUCCEEDED'
}

export type PerformerBatchSummary = {
  __typename?: 'PerformerBatchSummary';
...
export type PerformerSubscriptionEvent = {
  __typename?: 'PerformerSubscriptionEvent';
  performerId: Scalars['ID']['output'];
  sequence: Scalars['Int']['output'];
  state?: Maybe<SubscribedPerformer>;
...
export enum PerformerSubscriptionEventType {
  Created = 'CREATED',
  Deleted = 'DELETED',
  Updated = 'UPDATED'
}

export type PerformerWorkspaceSnapshot = {
  __typename?: 'PerformerWorkspaceSnapshot';
...
export type Query = {
  ...
  performerWorkspace: PerformerWorkspaceSnapshot;
...
export type QueryPerformerWorkspaceArgs = {
...
export type QueuePerformerScenesInput = {
  ...
  sceneKeys: Array<Scalars['ID']['input']>;
};
...
export type StashBoxDataCacheSettings = {
  __typename?: 'StashBoxDataCacheSettings';
  ttlHours: Scalars['Int']['output'];
};

export type StashBoxDataCacheSettingsInput = {
  ttlHours: Scalars['Int']['input'];
};

export type StashBoxDataCacheStatus = {
  __typename?: 'StashBoxDataCacheStatus';
...
export type StashPerformerSceneConnection = {
  ...
  cacheComplete: Scalars['Boolean']['output'];
  cacheStale: Scalars['Boolean']['output'];
  cacheUpdatedAt?: Maybe<Scalars['String']['output']>;
  ...
  stashBoxLoadedCount: Scalars['Int']['output'];
  stashBoxRemoteCount: Scalars['Int']['output'];
  stashSceneCount: Scalars['Int']['output'];
  totalCount: Scalars['Int']['output'];
  totalCountExact: Scalars['Boolean']['output'];
...
export type TaskBatchPayload = {
  __typename?: 'TaskBatchPayload';
  batchId: Scalars['ID']['output'];
  results: Array<TaskBatchResult>;
  summary: TaskBatchSummary;
};

export type TaskBatchResult = {
  __typename?: 'TaskBatchResult';
  reasonCode: Scalars['String']['output'];
...
export type TaskBatchSummary = {
  __typename?: 'TaskBatchSummary';
  failedCount: Scalars['Int']['output'];
  requestedCount: Scalars['Int']['output'];
  skippedCount: Scalars['Int']['output'];
  succeededCount: Scalars['Int']['output'];
...
export type UpdateSystemSettingsInput = {
  ...
  stashBoxDataCache?: InputMaybe<StashBoxDataCacheSettingsInput>;
  taskDeletePolicy: TaskDeletePolicy;
};
...
export type PerformerSubscriptionEventsSubscriptionVariables = Exact<{ [key: string]: never; }>;


export type PerformerSubscriptionEventsSubscription = { __typename?: 'Subscription', performerSubscriptionEvents: { __typename?: 'PerformerSubscriptionEvent', sequence: number, type: PerformerSubscriptionEventType, performerId: string, state?: { __typename?: 'SubscribedPerformer', lastCheckedAt?: string | null, lastError?: string | null, pendingReleaseCount: number, processedReleaseCount: number, performer: { __typename?: 'StashPerformer', id: string, name: string, aliasList: Array<string>, favorite: boolean, imagePath?: string | null, sceneCount: number, subscribed: boolean }, recentReleases: Array<{ __typename?: 'SubscriptionRelease', key: string, title: string, code?: string | null, date?: string | null, seenAt: string }> } | null } };
...
export type ConnectionsSettingsQueryVariables = Exact<{ [key: string]: never; }>;


export type ConnectionsSettingsQuery = { __typename?: 'Query', settings: { __typename?: 'Settings', stash: { __typename?: 'StashSettings', configured: boolean, url: string, apiKeyConfigured: boolean, apiKey: string }, jackett: { __typename?: 'JackettSettings', configured: boolean, url: string, apiKeyConfigured: boolean, apiKey: string, passwordConfigured: boolean, password: string }, qbittorrent: { __typename?: 'QBittorrentSettings', configured: boolean, url: string, username: string, usernameConfigured: boolean, passwordConfigured: boolean, password: string, defaultSavePath: string, category: string, tags: string } } };

export type ConnectionsStatusQueryVariables = Exact<{ [key: string]: never; }>;


export type ConnectionsStatusQuery = { __typename?: 'Query', settingsStatus: { __typename?: 'SettingsStatus', stash: { __typename?: 'ServiceStatus', configured: boolean, ready: boolean }, jackett: { __typename?: 'ServiceStatus', configured: boolean, ready: boolean }, qbittorrent: { __typename?: 'ServiceStatus', configured: boolean, ready: boolean }, stashStats: { __typename?: 'StashStats', lastError?: string | null, okAt?: string | null }, jackettStats: { __typename?: 'JackettStats', lastError?: string | null, okAt?: string | null }, qbittorrentStats: { __typename?: 'QBittorrentStats', lastError?: string | null, okAt?: string | null } } };

export type IngestSettingsTabQueryVariables = Exact<{ [key: string]: never; }>;


export type IngestSettingsTabQuery = { __typename?: 'Query', settings: { __typename?: 'Settings', ingest: { __typename?: 'IngestSettings', deliveryMode: string, downloads: { __typename?: 'DownloadsIngestSettings', qbRoot: string, mojiRoot: string }, library: { __typename?: 'LibraryIngestSettings', mojiRoot: string, stashRoot: string }, transfer: { __typename?: 'TransferIngestSettings', action: string } }, qbittorrent: { __typename?: 'QBittorrentSettings', defaultSavePath: string } }, settingsStatus: { __typename?: 'SettingsStatus', stashLibrariesLoadError?: string | null, stashLibraries: Array<{ __typename?: 'StashLibrary', path: string }> } };

export type AutomationSettingsTabQueryVariables = Exact<{ [key: string]: never; }>;


export type AutomationSettingsTabQuery = { __typename?: 'Query', settings: { __typename?: 'Settings', automation: { __typename?: 'AutomationSettings', taskProgressSyncIntervalSeconds: number, subscriptionPollIntervalHours: number, stashBoxEndpoints: Array<string>, subscriptionReleasePolicy: { __typename?: 'SubscriptionReleasePolicy', soloBehavior: SubscriptionReleaseBehavior, groupBehavior: SubscriptionReleaseBehavior, compilationBehavior: SubscriptionReleaseBehavior, maxGroupPerformerCount: number, releaseDateRange: SubscriptionReleaseDateRange }, torrentSelection: { __typename?: 'TorrentSelectionSettings', enabled: boolean, inspectionCandidateLimit: number, fastRules: Array<{ __typename?: 'TorrentSelectionRule', type: TorrentSelectionRuleType, enabled: boolean, publishDate: { __typename?: 'DirectionRule', direction: TorrentSelectionDirection }, seeders: { __typename?: 'DirectionRule', direction: TorrentSelectionDirection }, size: { __typename?: 'DirectionRule', direction: TorrentSelectionDirection }, indexerPreference: { __typename?: 'IndexerPreferenceRule', trackerIds: Array<string> }, titleMatch: { __typename?: 'TitleMatchRule', clauses: Array<{ __typename?: 'TitleMatchClause', pattern: string, patternMode: TitleMatchPatternMode, effect: TitleMatchEffect }> }, torrentFileNameMatch: { __typename?: 'TorrentFileNameMatchRule', clauses: Array<{ __typename?: 'TorrentFileNameMatchClause', pattern: string, patternMode: TitleMatchPatternMode, effect: TorrentFileMatchEffect }> } }>, torrentRules: Array<{ __typename?: 'TorrentSelectionRule', type: TorrentSelectionRuleType, enabled: boolean, publishDate: { __typename?: 'DirectionRule', direction: TorrentSelectionDirection }, seeders: { __typename?: 'DirectionRule', direction: TorrentSelectionDirection }, size: { __typename?: 'DirectionRule', direction: TorrentSelectionDirection }, indexerPreference: { __typename?: 'IndexerPreferenceRule', trackerIds: Array<string> }, titleMatch: { __typename?: 'TitleMatchRule', clauses: Array<{ __typename?: 'TitleMatchClause', pattern: string, patternMode: TitleMatchPatternMode, effect: TitleMatchEffect }> }, torrentFileNameMatch: { __typename?: 'TorrentFileNameMatchRule', clauses: Array<{ __typename?: 'TorrentFileNameMatchClause', pattern: string, patternMode: TitleMatchPatternMode, effect: TorrentFileMatchEffect }> } }> } } }, settingsStatus: { __typename?: 'SettingsStatus', automation: { __typename?: 'AutomationStatus', taskProgressSyncIntervalSeconds: number, taskProgressSyncEnabled: boolean, subscriptionPollIntervalHours: number, subscriptionPollEnabled: boolean }, stashBox: { __typename?: 'StashBoxStatus', stashBoxesLoaded: boolean, stashBoxesLoadError?: string | null, stashBoxes: Array<{ __typename?: 'StashBoxEndpoint', name: string, endpoint: string, apiKeyConfigured: boolean }> } } };

export type SystemSettingsTabQueryVariables = Exact<{ [key: string]: never; }>;


export type SystemSettingsTabQuery = { __typename?: 'Query', settings: { __typename?: 'Settings', system: { __typename?: 'SystemSettings', taskDeletePolicy: TaskDeletePolicy, imageCache: { __typename?: 'ImageCacheSettings', enabled: boolean, maxSizeMb: number, retentionDays: number }, stashBoxDataCache: { __typename?: 'StashBoxDataCacheSettings', ttlHours: number } } }, settingsStatus: { __typename?: 'SettingsStatus', imageCache: { __typename?: 'ImageCacheStatus', usedBytes: any, entryCount: number, cacheDirectory: string, lastCleanupAt?: string | null, lastError?: string | null }, stashBoxDataCache: { __typename?: 'StashBoxDataCacheStatus', usedBytes: any, sceneCount: number, performerCount: number, snapshotCount: number, databasePath: string, lastCleanupAt?: string | null, lastError?: string | null } } };

export type AboutSettingsTabQueryVariables = Exact<{ [key: string]: never; }>;


export type AboutSettingsTabQuery = { __typename?: 'Query', version: string };
...
export type UpdateSystemSettingsDocumentMutation = { __typename?: 'Mutation', updateSystemSettings: { __typename?: 'Settings', system: { __typename?: 'SystemSettings', taskDeletePolicy: TaskDeletePolicy, imageCache: { __typename?: 'ImageCacheSettings', enabled: boolean, maxSizeMb: number, retentionDays: number }, stashBoxDataCache: { __typename?: 'StashBoxDataCacheSettings', ttlHours: number } } } };
...
export type ClearStashBoxDataCacheDocumentMutationVariables = Exact<{ [key: string]: never; }>;


export type ClearStashBoxDataCacheDocumentMutation = { __typename?: 'Mutation', clearStashBoxDataCache: { __typename?: 'StashBoxDataCacheStatus', usedBytes: any, sceneCount: number, performerCount: number, snapshotCount: number, databasePath: string, lastCleanupAt?: string | null, lastError?: string | null } };
...
export type PerformerWorkspaceQueryVariables = Exact<{
  search?: InputMaybe<Scalars['String']['input']>;
  page?: InputMaybe<Scalars['Int']['input']>;
  pageSize?: InputMaybe<Scalars['Int']['input']>;
}>;
...
export type PerformerWorkspaceQuery = { __typename?: 'Query', performerWorkspace: { __typename?: 'PerformerWorkspaceSnapshot', performers: { __typename?: 'StashPerformerConnection', page: number, pageSize: number, totalCount: number, totalPages: number, hasPrevPage: boolean, hasNextPage: boolean, items: Array<{ __typename?: 'StashPerformer', id: string, name: string, aliasList: Array<string>, favorite: boolean, imagePath?: string | null, sceneCount: number, subscribed: boolean }> }, subscribedPerformers: Array<{ __typename?: 'SubscribedPerformer', lastCheckedAt?: string | null, lastError?: string | null, pendingReleaseCount: number, processedReleaseCount: number, performer: { __typename?: 'StashPerformer', id: string, name: string, aliasList: Array<string>, favorite: boolean, imagePath?: string | null, sceneCount: number, subscribed: boolean }, recentReleases: Array<{ __typename?: 'SubscriptionRelease', key: string, title: string, code?: string | null, date?: string | null, seenAt: string }> }> } };
...
export type StashPerformerScenesQuery = { __typename?: 'Query', stashPerformerScenes: { __typename?: 'StashPerformerSceneConnection', page: number, pageSize: number, totalCount: number, totalPages?: number | null, hasPrevPage: boolean, hasNextPage: boolean, stashSceneCount: number, stashBoxCount: number, dedupedCount: number, totalCountExact: boolean, stashBoxRemoteCount: number, stashBoxLoadedCount: number, cacheComplete: boolean, cacheUpdatedAt?: string | null, cacheStale: boolean, items: Array<{ __typename?: 'StashPerformerScene', key: string, primarySource: SceneSource, sourceSceneId: string, title?: string | null, code?: string | null, date?: string | null, studioName?: string | null, performerCount: number, tagCount: number, imageUrl?: string | null, url?: string | null, inLibrary: boolean, matchedStashSceneId?: string | null, hasStashSource: boolean, hasStashBoxSource: boolean, stashBoxSceneId?: string | null, stashBoxEndpoint?: string | null, sourceLabels: Array<string>, performers: Array<{ __typename?: 'PerformerScenePerson', id: string, name: string }>, tags: Array<{ __typename?: 'PerformerSceneTag', id: string, name: string }>, stashIds: Array<{ __typename?: 'StashSceneID', endpoint: string, stashId: string }>, mojiTask?: { __typename?: 'PerformerSceneTask', id: string, stage: TaskStage, stageStatus: TaskStageStatus, stageLabel: string, stageStatusLabel: string, progress: number } | null }> } };

export type RefreshStashPerformerScenesMutationVariables = Exact<{
  id: Scalars['ID']['input'];
  input: StashPerformerScenesInput;
}>;


export type RefreshStashPerformerScenesMutation = { __typename?: 'Mutation', refreshStashPerformerScenes: { __typename?: 'StashPerformerSceneConnection', page: number, pageSize: number, totalCount: number, totalPages?: number | null, hasPrevPage: boolean, hasNextPage: boolean, stashSceneCount: number, stashBoxCount: number, dedupedCount: number, totalCountExact: boolean, stashBoxRemoteCount: number, stashBoxLoadedCount: number, cacheComplete: boolean, cacheUpdatedAt?: string | null, cacheStale: boolean, items: Array<{ __typename?: 'StashPerformerScene', key: string }> } };
...
export type SubscribePerformersMutationVariables = Exact<{
  ids: Array<Scalars['ID']['input']> | Scalars['ID']['input'];
}>;


export type SubscribePerformersMutation = { __typename?: 'Mutation', subscribePerformers: (
    { __typename?: 'PerformerBatchPayload' }
    & { ' $fragmentRefs'?: { 'PerformerBatchFieldsFragment': PerformerBatchFieldsFragment } }
  ) };

export type UnsubscribePerformersMutationVariables = Exact<{
  ids: Array<Scalars['ID']['input']> | Scalars['ID']['input'];
}>;


export type UnsubscribePerformersMutation = { __typename?: 'Mutation', unsubscribePerformers: (
    { __typename?: 'PerformerBatchPayload' }
    & { ' $fragmentRefs'?: { 'PerformerBatchFieldsFragment': PerformerBatchFieldsFragment } }
  ) };

export type RefreshSubscribedPerformersMutationVariables = Exact<{
  ids: Array<Scalars['ID']['input']> | Scalars['ID']['input'];
}>;


export type RefreshSubscribedPerformersMutation = { __typename?: 'Mutation', refreshSubscribedPerformers: (
    { __typename?: 'PerformerBatchPayload' }
    & { ' $fragmentRefs'?: { 'PerformerBatchFieldsFragment': PerformerBatchFieldsFragment } }
  ) };

export type PerformerBatchFieldsFragment = { __typename?: 'PerformerBatchPayload', batchId: string, summary: { __typename?: 'PerformerBatchSummary', requestedCount: number, succeededCount: number, skippedCount: number, failedCount: number }, results: Array<{ __typename?: 'PerformerBatchResult', performerId: string, status: PerformerBatchStatus, reasonCode: string, performer?: { __typename?: 'StashPerformer', id: string, name: string, aliasList: Array<string>, favorite: boolean, imagePath?: string | null, sceneCount: number, subscribed: boolean } | null, state?: { __typename?: 'SubscribedPerformer', lastCheckedAt?: string | null, lastError?: string | null, pendingReleaseCount: number, processedReleaseCount: number, performer: { __typename?: 'StashPerformer', id: string, name: string, aliasList: Array<string>, favorite: boolean, imagePath?: string | null, sceneCount: number, subscribed: boolean }, recentReleases: Array<{ __typename?: 'SubscriptionRelease', key: string, title: string, code?: string | null, date?: string | null, seenAt: string }> } | null }> } & { ' $fragmentName'?: 'PerformerBatchFieldsFragment' };
...
export type QueuePerformerScenesMutation = { __typename?: 'Mutation', queuePerformerScenes: { __typename?: 'QueuePerformerScenesPayload', queuedTasks: Array<{ __typename?: 'Task', id: string, source: TaskSource, stage: TaskStage, stageStatus: TaskStageStatus, code: string, createdAt: string }>, results: Array<{ __typename?: 'QueuePerformerSceneResult', key: string, status: QueuePerformerSceneStatus, reasonCode: string, resolvedCode?: string | null, task?: { __typename?: 'Task', id: string, stage: TaskStage, stageStatus: TaskStageStatus } | null }>, summary: { __typename?: 'QueuePerformerScenesSummary', requestedCount: number, queuedCount: number, skippedCount: number, failedCount: number } } };
...
export type TasksOverviewDocumentQuery = { __typename?: 'Query', dashboardStats: { __typename?: 'DashboardStats', total: number, active: number, completed: number, downloading: number, pendingScans: number, failed: number }, tasks: Array<{ __typename?: 'Task', id: string, source: TaskSource, code: string, stage: TaskStage, stageStatus: TaskStageStatus, stageLabel: string, stageStatusLabel: string, stageErrorCode?: string | null, stageErrorMessage?: string | null, torrentUrl: string, torrentName?: string | null, progress: number, qbittorrentState?: string | null, contentPath?: string | null, torrentHash?: string | null, savePath?: string | null, category?: string | null, tags?: string | null, downloadCompletedAt?: string | null, deliveryMode?: string | null, mojiSourcePath?: string | null, transferAction?: string | null, mojiTransferPath?: string | null, transferError?: string | null, stashScanJobId?: string | null, stashScanPath?: string | null, stashScanError?: string | null, stashScanHint?: string | null, stashScanStartedAt?: string | null, createdAt: string, updatedAt: string }>, settings: { __typename?: 'Settings', system: { __typename?: 'SystemSettings', taskDeletePolicy: TaskDeletePolicy } }, settingsStatus: { __typename?: 'SettingsStatus', automation: { __typename?: 'AutomationStatus', taskProgressSyncIntervalSeconds: number, taskProgressSyncEnabled: boolean } } };
...
export type RetryTasksDocumentMutationVariables = Exact<{
  ids: Array<Scalars['ID']['input']> | Scalars['ID']['input'];
}>;


export type RetryTasksDocumentMutation = { __typename?: 'Mutation', retryTasks: { __typename?: 'TaskBatchPayload', batchId: string, summary: { __typename?: 'TaskBatchSummary', requestedCount: number, succeededCount: number, skippedCount: number, failedCount: number }, results: Array<{ __typename?: 'TaskBatchResult', taskId: string, status: TaskBatchStatus, reasonCode: string, task?: { __typename?: 'Task', id: string, source: TaskSource, code: string, stage: TaskStage, stageStatus: TaskStageStatus, stageLabel: string, stageStatusLabel: string, progress: number, qbittorrentState?: string | null, updatedAt: string } | null }> } };

export type ProcessTaskIngestDocumentMutationVariables = Exact<{
  ids: Array<Scalars['ID']['input']> | Scalars['ID']['input'];
}>;


export type ProcessTaskIngestDocumentMutation = { __typename?: 'Mutation', processTaskIngest: { __typename?: 'TaskBatchPayload', batchId: string, summary: { __typename?: 'TaskBatchSummary', requestedCount: number, succeededCount: number, skippedCount: number, failedCount: number }, results: Array<{ __typename?: 'TaskBatchResult', taskId: string, status: TaskBatchStatus, reasonCode: string, task?: { __typename?: 'Task', id: string, source: TaskSource, code: string, stage: TaskStage, stageStatus: TaskStageStatus, stageLabel: string, stageStatusLabel: string, progress: number, deliveryMode?: string | null, transferError?: string | null, stashScanJobId?: string | null, stashScanPath?: string | null, stashScanError?: string | null, stashScanHint?: string | null, updatedAt: string } | null }> } };

export type DeleteTasksDocumentMutationVariables = Exact<{
  ids: Array<Scalars['ID']['input']> | Scalars['ID']['input'];
}>;


export type DeleteTasksDocumentMutation = { __typename?: 'Mutation', deleteTasks: { __typename?: 'TaskBatchPayload', batchId: string, summary: { __typename?: 'TaskBatchSummary', requestedCount: number, succeededCount: number, skippedCount: number, failedCount: number }, results: Array<{ __typename?: 'TaskBatchResult', taskId: string, status: TaskBatchStatus, reasonCode: string, task?: { __typename?: 'Task', id: string, code: string, stage: TaskStage, stageStatus: TaskStageStatus, updatedAt: string } | null }> } };
...
export const PerformerSubscriptionEventsDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"subscription","name":{"kind":"Name","value":"PerformerSubscriptionEvents"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"performerSubscriptionEvents"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"sequence"}},{"kind":"Field","name":{"kind":"Name","value":"type"}},{"kind":"Field","name":{"kind":"Name","value":"performerId"}},{"kind":"Field","name":{"kind":"Name","value":"state"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"performer"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"name"}},{"kind":"Field","name":{"kind":"Name","value":"aliasList"}},{"kind":"Field","name":{"kind":"Name","value":"favorite"}},{"kind":"Field","name":{"kind":"Name","value":"imagePath"}},{"kind":"Field","name":{"kind":"Name","value":"sceneCount"}},{"kind":"Field","name":{"kind":"Name","value":"subscribed"}}]}},{"kind":"Field","name":{"kind":"Name","value":"lastCheckedAt"}},{"kind":"Field","name":{"kind":"Name","value":"lastError"}},{"kind":"Field","name":{"kind":"Name","value":"pendingReleaseCount"}},{"kind":"Field","name":{"kind":"Name","value":"processedReleaseCount"}},{"kind":"Field","name":{"kind":"Name","value":"recentReleases"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"key"}},{"kind":"Field","name":{"kind":"Name","value":"title"}},{"kind":"Field","name":{"kind":"Name","value":"code"}},{"kind":"Field","name":{"kind":"Name","value":"date"}},{"kind":"Field","name":{"kind":"Name","value":"seenAt"}}]}}]}}]}}]}}]} as unknown as DocumentNode<PerformerSubscriptionEventsSubscription, PerformerSubscriptionEventsSubscriptionVariables>;
...
export const ClearStashBoxDataCacheDocumentDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"ClearStashBoxDataCacheDocument"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"clearStashBoxDataCache"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"usedBytes"}},{"kind":"Field","name":{"kind":"Name","value":"sceneCount"}},{"kind":"Field","name":{"kind":"Name","value":"performerCount"}},{"kind":"Field","name":{"kind":"Name","value":"snapshotCount"}},{"kind":"Field","name":{"kind":"Name","value":"databasePath"}},{"kind":"Field","name":{"kind":"Name","value":"lastCleanupAt"}},{"kind":"Field","name":{"kind":"Name","value":"lastError"}}]}}]}}]} as unknown as DocumentNode<ClearStashBoxDataCacheDocumentMutation, ClearStashBoxDataCacheDocumentMutationVariables>;
...
export const PerformerWorkspaceDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"PerformerWorkspace"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"search"}},"type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"page"}},"type":{"kind":"NamedType","name":{"kind":"Name","value":"Int"}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"pageSize"}},"type":{"kind":"NamedType","name":{"kind":"Name","value":"Int"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"performerWorkspace"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"search"},"value":{"kind":"Variable","name":{"kind":"Name","value":"search"}}},{"kind":"Argument","name":{"kind":"Name","value":"page"},"value":{"kind":"Variable","name":{"kind":"Name","value":"page"}}},{"kind":"Argument","name":{"kind":"Name","value":"pageSize"},"value":{"kind":"Variable","name":{"kind":"Name","value":"pageSize"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"performers"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"items"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"name"}},{"kind":"Field","name":{"kind":"Name","value":"aliasList"}},{"kind":"Field","name":{"kind":"Name","value":"favorite"}},{"kind":"Field","name":{"kind":"Name","value":"imagePath"}},{"kind":"Field","name":{"kind":"Name","value":"sceneCount"}},{"kind":"Field","name":{"kind":"Name","value":"subscribed"}}]}},{"kind":"Field","name":{"kind":"Name","value":"page"}},{"kind":"Field","name":{"kind":"Name","value":"pageSize"}},{"kind":"Field","name":{"kind":"Name","value":"totalCount"}},{"kind":"Field","name":{"kind":"Name","value":"totalPages"}},{"kind":"Field","name":{"kind":"Name","value":"hasPrevPage"}},{"kind":"Field","name":{"kind":"Name","value":"hasNextPage"}}]}},{"kind":"Field","name":{"kind":"Name","value":"subscribedPerformers"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"performer"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"name"}},{"kind":"Field","name":{"kind":"Name","value":"aliasList"}},{"kind":"Field","name":{"kind":"Name","value":"favorite"}},{"kind":"Field","name":{"kind":"Name","value":"imagePath"}},{"kind":"Field","name":{"kind":"Name","value":"sceneCount"}},{"kind":"Field","name":{"kind":"Name","value":"subscribed"}}]}},{"kind":"Field","name":{"kind":"Name","value":"lastCheckedAt"}},{"kind":"Field","name":{"kind":"Name","value":"lastError"}},{"kind":"Field","name":{"kind":"Name","value":"pendingReleaseCount"}},{"kind":"Field","name":{"kind":"Name","value":"processedReleaseCount"}},{"kind":"Field","name":{"kind":"Name","value":"recentReleases"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"key"}},{"kind":"Field","name":{"kind":"Name","value":"title"}},{"kind":"Field","name":{"kind":"Name","value":"code"}},{"kind":"Field","name":{"kind":"Name","value":"date"}},{"kind":"Field","name":{"kind":"Name","value":"seenAt"}}]}}]}}]}}]}}]} as unknown as DocumentNode<PerformerWorkspaceQuery, PerformerWorkspaceQueryVariables>;
...
export const SubscribePerformersDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"SubscribePerformers"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"ids"}},"type":{"kind":"NonNullType","type":{"kind":"ListType","type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"ID"}}}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"subscribePerformers"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"ids"},"value":{"kind":"Variable","name":{"kind":"Name","value":"ids"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"FragmentSpread","name":{"kind":"Name","value":"PerformerBatchFields"}}]}}]}},{"kind":"FragmentDefinition","name":{"kind":"Name","value":"PerformerBatchFields"},"typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"PerformerBatchPayload"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"batchId"}},{"kind":"Field","name":{"kind":"Name","value":"summary"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"requestedCount"}},{"kind":"Field","name":{"kind":"Name","value":"succeededCount"}},{"kind":"Field","name":{"kind":"Name","value":"skippedCount"}},{"kind":"Field","name":{"kind":"Name","value":"failedCount"}}]}},{"kind":"Field","name":{"kind":"Name","value":"results"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"performerId"}},{"kind":"Field","name":{"kind":"Name","value":"status"}},{"kind":"Field","name":{"kind":"Name","value":"reasonCode"}},{"kind":"Field","name":{"kind":"Name","value":"performer"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"name"}},{"kind":"Field","name":{"kind":"Name","value":"aliasList"}},{"kind":"Field","name":{"kind":"Name","value":"favorite"}},{"kind":"Field","name":{"kind":"Name","value":"imagePath"}},{"kind":"Field","name":{"kind":"Name","value":"sceneCount"}},{"kind":"Field","name":{"kind":"Name","value":"subscribed"}}]}},{"kind":"Field","name":{"kind":"Name","value":"state"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"performer"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"name"}},{"kind":"Field","name":{"kind":"Name","value":"aliasList"}},{"kind":"Field","name":{"kind":"Name","value":"favorite"}},{"kind":"Field","name":{"kind":"Name","value":"imagePath"}},{"kind":"Field","name":{"kind":"Name","value":"sceneCount"}},{"kind":"Field","name":{"kind":"Name","value":"subscribed"}}]}},{"kind":"Field","name":{"kind":"Name","value":"lastCheckedAt"}},{"kind":"Field","name":{"kind":"Name","value":"lastError"}},{"kind":"Field","name":{"kind":"Name","value":"pendingReleaseCount"}},{"kind":"Field","name":{"kind":"Name","value":"processedReleaseCount"}},{"kind":"Field","name":{"kind":"Name","value":"recentReleases"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"key"}},{"kind":"Field","name":{"kind":"Name","value":"title"}},{"kind":"Field","name":{"kind":"Name","value":"code"}},{"kind":"Field","name":{"kind":"Name","value":"date"}},{"kind":"Field","name":{"kind":"Name","value":"seenAt"}}]}}]}}]}}]}}]} as unknown as DocumentNode<SubscribePerformersMutation, SubscribePerformersMutationVariables>;
export const UnsubscribePerformersDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"UnsubscribePerformers"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"ids"}},"type":{"kind":"NonNullType","type":{"kind":"ListType","type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"ID"}}}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"unsubscribePerformers"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"ids"},"value":{"kind":"Variable","name":{"kind":"Name","value":"ids"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"FragmentSpread","name":{"kind":"Name","value":"PerformerBatchFields"}}]}}]}},{"kind":"FragmentDefinition","name":{"kind":"Name","value":"PerformerBatchFields"},"typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"PerformerBatchPayload"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"batchId"}},{"kind":"Field","name":{"kind":"Name","value":"summary"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"requestedCount"}},{"kind":"Field","name":{"kind":"Name","value":"succeededCount"}},{"kind":"Field","name":{"kind":"Name","value":"skippedCount"}},{"kind":"Field","name":{"kind":"Name","value":"failedCount"}}]}},{"kind":"Field","name":{"kind":"Name","value":"results"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"performerId"}},{"kind":"Field","name":{"kind":"Name","value":"status"}},{"kind":"Field","name":{"kind":"Name","value":"reasonCode"}},{"kind":"Field","name":{"kind":"Name","value":"performer"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"name"}},{"kind":"Field","name":{"kind":"Name","value":"aliasList"}},{"kind":"Field","name":{"kind":"Name","value":"favorite"}},{"kind":"Field","name":{"kind":"Name","value":"imagePath"}},{"kind":"Field","name":{"kind":"Name","value":"sceneCount"}},{"kind":"Field","name":{"kind":"Name","value":"subscribed"}}]}},{"kind":"Field","name":{"kind":"Name","value":"state"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"performer"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"name"}},{"kind":"Field","name":{"kind":"Name","value":"aliasList"}},{"kind":"Field","name":{"kind":"Name","value":"favorite"}},{"kind":"Field","name":{"kind":"Name","value":"imagePath"}},{"kind":"Field","name":{"kind":"Name","value":"sceneCount"}},{"kind":"Field","name":{"kind":"Name","value":"subscribed"}}]}},{"kind":"Field","name":{"kind":"Name","value":"lastCheckedAt"}},{"kind":"Field","name":{"kind":"Name","value":"lastError"}},{"kind":"Field","name":{"kind":"Name","value":"pendingReleaseCount"}},{"kind":"Field","name":{"kind":"Name","value":"processedReleaseCount"}},{"kind":"Field","name":{"kind":"Name","value":"recentReleases"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"key"}},{"kind":"Field","name":{"kind":"Name","value":"title"}},{"kind":"Field","name":{"kind":"Name","value":"code"}},{"kind":"Field","name":{"kind":"Name","value":"date"}},{"kind":"Field","name":{"kind":"Name","value":"seenAt"}}]}}]}}]}}]}}]} as unknown as DocumentNode<UnsubscribePerformersMutation, UnsubscribePerformersMutationVariables>;
export const RefreshSubscribedPerformersDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"RefreshSubscribedPerformers"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"ids"}},"type":{"kind":"NonNullType","type":{"kind":"ListType","type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"ID"}}}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"refreshSubscribedPerformers"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"ids"},"value":{"kind":"Variable","name":{"kind":"Name","value":"ids"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"FragmentSpread","name":{"kind":"Name","value":"PerformerBatchFields"}}]}}]}},{"kind":"FragmentDefinition","name":{"kind":"Name","value":"PerformerBatchFields"},"typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"PerformerBatchPayload"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"batchId"}},{"kind":"Field","name":{"kind":"Name","value":"summary"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"requestedCount"}},{"kind":"Field","name":{"kind":"Name","value":"succeededCount"}},{"kind":"Field","name":{"kind":"Name","value":"skippedCount"}},{"kind":"Field","name":{"kind":"Name","value":"failedCount"}}]}},{"kind":"Field","name":{"kind":"Name","value":"results"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"performerId"}},{"kind":"Field","name":{"kind":"Name","value":"status"}},{"kind":"Field","name":{"kind":"Name","value":"reasonCode"}},{"kind":"Field","name":{"kind":"Name","value":"performer"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"name"}},{"kind":"Field","name":{"kind":"Name","value":"aliasList"}},{"kind":"Field","name":{"kind":"Name","value":"favorite"}},{"kind":"Field","name":{"kind":"Name","value":"imagePath"}},{"kind":"Field","name":{"kind":"Name","value":"sceneCount"}},{"kind":"Field","name":{"kind":"Name","value":"subscribed"}}]}},{"kind":"Field","name":{"kind":"Name","value":"state"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"performer"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"name"}},{"kind":"Field","name":{"kind":"Name","value":"aliasList"}},{"kind":"Field","name":{"kind":"Name","value":"favorite"}},{"kind":"Field","name":{"kind":"Name","value":"imagePath"}},{"kind":"Field","name":{"kind":"Name","value":"sceneCount"}},{"kind":"Field","name":{"kind":"Name","value":"subscribed"}}]}},{"kind":"Field","name":{"kind":"Name","value":"lastCheckedAt"}},{"kind":"Field","name":{"kind":"Name","value":"lastError"}},{"kind":"Field","name":{"kind":"Name","value":"pendingReleaseCount"}},{"kind":"Field","name":{"kind":"Name","value":"processedReleaseCount"}},{"kind":"Field","name":{"kind":"Name","value":"recentReleases"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"key"}},{"kind":"Field","name":{"kind":"Name","value":"title"}},{"kind":"Field","name":{"kind":"Name","value":"code"}},{"kind":"Field","name":{"kind":"Name","value":"date"}},{"kind":"Field","name":{"kind":"Name","value":"seenAt"}}]}}]}}]}}]}}]} as unknown as DocumentNode<RefreshSubscribedPerformersMutation, RefreshSubscribedPerformersMutationVariables>;
...
export const RetryTasksDocumentDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"RetryTasksDocument"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"ids"}},"type":{"kind":"NonNullType","type":{"kind":"ListType","type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"ID"}}}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"retryTasks"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"ids"},"value":{"kind":"Variable","name":{"kind":"Name","value":"ids"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"batchId"}},{"kind":"Field","name":{"kind":"Name","value":"summary"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"requestedCount"}},{"kind":"Field","name":{"kind":"Name","value":"succeededCount"}},{"kind":"Field","name":{"kind":"Name","value":"skippedCount"}},{"kind":"Field","name":{"kind":"Name","value":"failedCount"}}]}},{"kind":"Field","name":{"kind":"Name","value":"results"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"taskId"}},{"kind":"Field","name":{"kind":"Name","value":"status"}},{"kind":"Field","name":{"kind":"Name","value":"reasonCode"}},{"kind":"Field","name":{"kind":"Name","value":"task"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"source"}},{"kind":"Field","name":{"kind":"Name","value":"code"}},{"kind":"Field","name":{"kind":"Name","value":"stage"}},{"kind":"Field","name":{"kind":"Name","value":"stageStatus"}},{"kind":"Field","name":{"kind":"Name","value":"stageLabel"}},{"kind":"Field","name":{"kind":"Name","value":"stageStatusLabel"}},{"kind":"Field","name":{"kind":"Name","value":"progress"}},{"kind":"Field","name":{"kind":"Name","value":"qbittorrentState"}},{"kind":"Field","name":{"kind":"Name","value":"updatedAt"}}]}}]}}]}}]}}]} as unknown as DocumentNode<RetryTasksDocumentMutation, RetryTasksDocumentMutationVariables>;
export const ProcessTaskIngestDocumentDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"ProcessTaskIngestDocument"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"ids"}},"type":{"kind":"NonNullType","type":{"kind":"ListType","type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"ID"}}}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"processTaskIngest"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"ids"},"value":{"kind":"Variable","name":{"kind":"Name","value":"ids"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"batchId"}},{"kind":"Field","name":{"kind":"Name","value":"summary"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"requestedCount"}},{"kind":"Field","name":{"kind":"Name","value":"succeededCount"}},{"kind":"Field","name":{"kind":"Name","value":"skippedCount"}},{"kind":"Field","name":{"kind":"Name","value":"failedCount"}}]}},{"kind":"Field","name":{"kind":"Name","value":"results"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"taskId"}},{"kind":"Field","name":{"kind":"Name","value":"status"}},{"kind":"Field","name":{"kind":"Name","value":"reasonCode"}},{"kind":"Field","name":{"kind":"Name","value":"task"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"source"}},{"kind":"Field","name":{"kind":"Name","value":"code"}},{"kind":"Field","name":{"kind":"Name","value":"stage"}},{"kind":"Field","name":{"kind":"Name","value":"stageStatus"}},{"kind":"Field","name":{"kind":"Name","value":"stageLabel"}},{"kind":"Field","name":{"kind":"Name","value":"stageStatusLabel"}},{"kind":"Field","name":{"kind":"Name","value":"progress"}},{"kind":"Field","name":{"kind":"Name","value":"deliveryMode"}},{"kind":"Field","name":{"kind":"Name","value":"transferError"}},{"kind":"Field","name":{"kind":"Name","value":"stashScanJobId"}},{"kind":"Field","name":{"kind":"Name","value":"stashScanPath"}},{"kind":"Field","name":{"kind":"Name","value":"stashScanError"}},{"kind":"Field","name":{"kind":"Name","value":"stashScanHint"}},{"kind":"Field","name":{"kind":"Name","value":"updatedAt"}}]}}]}}]}}]}}]} as unknown as DocumentNode<ProcessTaskIngestDocumentMutation, ProcessTaskIngestDocumentMutationVariables>;
export const DeleteTasksDocumentDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"DeleteTasksDocument"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"ids"}},"type":{"kind":"NonNullType","type":{"kind":"ListType","type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"ID"}}}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"deleteTasks"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"ids"},"value":{"kind":"Variable","name":{"kind":"Name","value":"ids"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"batchId"}},{"kind":"Field","name":{"kind":"Name","value":"summary"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"requestedCount"}},{"kind":"Field","name":{"kind":"Name","value":"succeededCount"}},{"kind":"Field","name":{"kind":"Name","value":"skippedCount"}},{"kind":"Field","name":{"kind":"Name","value":"failedCount"}}]}},{"kind":"Field","name":{"kind":"Name","value":"results"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"taskId"}},{"kind":"Field","name":{"kind":"Name","value":"status"}},{"kind":"Field","name":{"kind":"Name","value":"reasonCode"}},{"kind":"Field","name":{"kind":"Name","value":"task"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"code"}},{"kind":"Field","name":{"kind":"Name","value":"stage"}},{"kind":"Field","name":{"kind":"Name","value":"stageStatus"}},{"kind":"Field","name":{"kind":"Name","value":"updatedAt"}}]}}]}}]}}]}}]} as unknown as DocumentNode<DeleteTasksDocumentMutation, DeleteTasksDocumentMutationVariables>;
