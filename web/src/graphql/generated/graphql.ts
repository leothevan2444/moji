...
export type DeleteTaskDocumentMutation = { __typename?: 'Mutation', deleteTask: { __typename?: 'Task', id: string, source: TaskSource, stage: TaskStage, stageStatus: TaskStageStatus, stageLabel: string, stageStatusLabel: string, query: string, code: string, updatedAt: string } };
