...
export type IngestSettings = {
  ...
  stashLibraryPath: Scalars['String']['output'];
...
export type TorrentSelectionSettings = {
  ...
  enabled: Scalars['Boolean']['output'];
  rules: Array<TorrentSelectionRule>;
};

export type TorrentSelectionSettingsInput = {
  enabled: Scalars['Boolean']['input'];
  rules: Array<TorrentSelectionRuleInput>;
};

export type TransferIngestSettings = {
  __typename?: 'TransferIngestSettings';
  action: Scalars['String']['output'];
  mojiSourceRoot: Scalars['String']['output'];
  mojiTargetRoot: Scalars['String']['output'];
};

export type TransferIngestSettingsInput = {
  action: Scalars['String']['input'];
  mojiSourceRoot: Scalars['String']['input'];
  mojiTargetRoot: Scalars['String']['input'];
};
...
export type UpdateIngestSettingsInput = {
  ...
  stashLibraryPath: Scalars['String']['input'];
...
export type UpdateIngestSettingsDocumentMutation = { __typename?: 'Mutation', updateIngestSettings: { __typename?: 'Settings', ingest: { __typename?: 'IngestSettings', deliveryMode: string, stashLibraryPath: string, transfer: { __typename?: 'TransferIngestSettings', action: string, mojiSourceRoot: string, mojiTargetRoot: string } } } };
...
export type UpdateAutomationSettingsDocumentMutation = { __typename?: 'Mutation', updateAutomationSettings: { __typename?: 'Settings', automation: { __typename?: 'AutomationSettings', taskProgressSyncIntervalSeconds: number, subscriptionPollIntervalHours: number, torrentSelection: { __typename?: 'TorrentSelectionSettings', enabled: boolean, rules: Array<{ __typename?: 'TorrentSelectionRule', id: string, type: TorrentSelectionRuleType, enabled: boolean, direction: TorrentSelectionDirection, indexerPreference: { __typename?: 'IndexerPreferenceRule', trackerIds: Array<string> }, titleMatch: { __typename?: 'TitleMatchRule', clauses: Array<{ __typename?: 'TitleMatchClause', pattern: string, patternMode: TitleMatchPatternMode, effect: TitleMatchEffect }> } }> } } } };
...
export type AddTorrentDocumentMutation = { __typename?: 'Mutation', addTorrent: { __typename?: 'Task', id: string, source: TaskSource, status: string, query: string, torrentName: string, progress: number, stashMode: string, stashScanStatus: string, createdAt: string } };
